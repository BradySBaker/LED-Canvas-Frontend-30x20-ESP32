...
export default function connectToBle(setIsConnected, turnOn, setAnims, setPrevFrameNames) {
	var paramFuncs = {setIsConnected, turnOn, setAnims, setPrevFrameNames};
...
blueTooth.startNotifications(window.blueToothCharacteristic, (value) => gotValue(value, paramFuncs.setAnims, paramFuncs.setPrevFrameNames), 'string');
